...
def save_stack(proc_stack, nametag = "None", save_directory = "Null"):
    ...
    Saves a processed stack as a pickled file:
        ...
        nametag: custom name to append to the front of the .stack pickle file
        save_directory: custom output directory for the pickled .stack file
    """
...
def get_stack(stack_pickle):
    ...
    Loads processed stack data from a pickled file:
        stack_pickle: string path to the pickled stack data .stack file
    """
