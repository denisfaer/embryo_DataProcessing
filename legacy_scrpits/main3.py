...
# main loop going 1-by-1 for each 'stack' folder detected
for given_stack in given_stacks:
    
    # set local stack directories
    ...
    """ normalize data """ ### THIS PART WILL BE UPDATED TO INLCUDE MORE NORMALIZATION OPTIONS
...
""" pickle global data """ ### THIS PART WILL BE HEAVILY CHANGED
